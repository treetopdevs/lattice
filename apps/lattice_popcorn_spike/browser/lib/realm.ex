defmodule LatticeBrowser.Realm do
  ...
  Keys are ephemeral and never returned across the bridge. The host is trusted;
  this API is component encapsulation, not protection from a browser owner/XSS.
  """
  use GenServer
  ...
  @impl true
  def init(_opts) do
    {:ok, %{identity: Identity.generate("popcorn-spike"), tab: nil, phase: :new, seq: 0}}
  end
