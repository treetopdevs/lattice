# Plan 162: Bind root-less delegations and genesis authorship to the replica root
...
- **Effort**: M — the production change is ~20 lines across two files. The work is the adversarial
