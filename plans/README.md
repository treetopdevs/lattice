...
| 161 | Close the three silent verification gaps (Sobelow, orphaned suites, format scope) | P1 | S–M | 165 Part B (rec.) | BLOCKED (review STOP: preflight is not device-free; witness smoke lacks a test-presence bundle; umbrella config is outside both Sobelow roots) |
