...
packaged macOS CI-enforcement gap. The active frontier remains G1 completion and the remaining
Phase G instrument work: server push, broader participant controls, production deployment, and W4.
