...
- **E1.** **Tauri v2 shell** (recommended spine): Vue 3.5 frontend + Rust core (key custody, CBOR,
  ...
  **Status:** started: the TS bridge, Rust command core, Tauri command registration, native
  ...
  mobile secure-store strategy contract, cold-start replay guard, named desktop `app:convergence` gate with default-namespace onboarding, concrete seed-byte app-KV checks,
