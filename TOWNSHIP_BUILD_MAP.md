...
> **Plan 147 closure candidate (hosted CI pending):** Tier A now retains command caps and
...
> client/carrier, packaged convergence, OTP 28, security, and Claude gates are green. F2/F3/F4
> remain open, and Plan 147 remains `IN PROGRESS` until exact-tip hosted CI passes.
...
- **G1.** Build the production UI: Phoenix LiveView 1.1 (state/feeds) + Vue 3.5 islands (canvases),
  ...
  **Status:** Phase G's audit surface is implemented by Plan 121, Plan 122 adds the shared read
  ...
  security, and Claude gates are green; exact-tip hosted closure remains pending. F2
  genesis-holder parity and the F3/F4 state-ordering gaps remain open. Legacy succession tick
