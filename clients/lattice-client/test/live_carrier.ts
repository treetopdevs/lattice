...
const residentGrantId = carrierDelegationsFromFrames(vector.clientDivergedCarrierOps).find(
  (delegation) => delegation.audience === residentAuthor.publicKeyBase64 && delegation.parent_id !== null,
)?.id;
if (!residentGrantId) throw new Error("missing resident delegation fixture");
