...
for (const producer of ["beam", "ts"] as const) test(`${producer} independently signed fixture verifies all four purposes and remains an unimplemented command`, async () => {
