...
test("review derives consent from signed history and assembly never invokes a signer before public judgment", async () => {
    ...
    assert.deepEqual(await assembleMemberContinuityFromFrames({ frames, review: reviewed.review, certificate, signer: malformedSigner }), { ok: false, reason: "invalid_verified_history" });
